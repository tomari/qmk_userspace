...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
           ...
           KC_ESC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LGUI,                        KC_APP,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,
        TT(_UPPER), KC_F12,  KC_DEL,  KC_RCTL, KC_LNG2, KC_LSFT, KC_SPC,                        KC_ENT,MO(_LOWER), KC_LNG1, TT(_NUM),KC_LEFT, KC_RGHT, KC_DOWN
  ),
  /* Lower
   * ,----------------------------------------------------------------------------------------------------------------------.
